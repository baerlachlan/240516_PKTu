...
```{r}
vcf <- file.path("smk-variants/results/variation/vcf/snvs.final.vcf")
groups <- list(
  eofad = metadata$sample[metadata$genotype_psen1 == "eofad"],
  fai = metadata$sample[metadata$genotype_psen1 == "fai"],
  wt = metadata$sample[metadata$genotype_psen1 == "wt"],
  tu = metadata$sample[metadata$genotype_chr14 == "tu"],
  pk = metadata$sample[metadata$genotype_chr14 == "pk"],
  het = metadata$sample[metadata$genotype_chr14 == "het"]
)
