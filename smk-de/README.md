...
1. Deploy the workflow
    ...
    - Clone smk-rnaseq-gatk-variants workflow from GitHub repository
        ...
        <!-- ```
        git@github.com:baerlachlan/smk-rnaseq-gatk-variants.git
...
5. Execute the workflow
    ...
    - `retries` option added as jobs were randomly failing, but would work when re-executed without any code changes.
      - This may be due to a version-specific bug.
